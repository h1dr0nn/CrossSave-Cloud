<script lang="ts">
    ...
    async function browsePath() {
        try {
            ...
            pushError(`Failed to select directory: ${error}`);
        }
    }
</script>
                ...
                <div class="input-stack">
                    ...
                    <div class="setting-item">
                        <div class="form-group">
                            ...
                            {#if profile}
                                <span class="hint"
                                    >ID cannot be changed after creation.</span
                                >
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="form-group">
                            ...
                            <div class="list-input-row">
                                ...
                                <button
                                    class="btn-secondary"
                                    on:click={browsePath}>Browse...</button
                                >
                                <button class="btn-secondary" on:click={addPath}
                                    >Add</button
                                >
                            </div>
                    ...
                    <div class="setting-item">
                        <div class="form-group">
                            ...
                            <div class="list-input-row">
                                ...
                                <button
                                    class="btn-secondary"
                                    on:click={addPattern}>Add</button
                                >
                            </div>
